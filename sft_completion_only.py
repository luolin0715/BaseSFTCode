...
class SFTDataset(Dataset):
    def __init__(self, file_path, tokenizer):
        ...
        self.examples = self.load_data(self.file_path)
...
# functools.partial
# 作用：创建一个新的函数，固定原函数的部分参数

# 效果：collate_fn(batch) = sft_collate(batch, tokenizer=tokenizer, end_str=..., max_length=50)
...
sft_dataset = SFTDataset("data_path", tokenizer)
